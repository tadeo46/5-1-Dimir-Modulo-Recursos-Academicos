...
public class Controller {
    ...
    boton_buscar_aula,boton_modificar_aula,boton_buscar_materia,boton_modificar_materia, boton_regresar;
    @FXML
    ...
    public void Regresarinicio(){
        Stage stage = (Stage) this.boton_regresar.getScene().getWindow();
        stage.close();
        ventanas.inicio();
    };
